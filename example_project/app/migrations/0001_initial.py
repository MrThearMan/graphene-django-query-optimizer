# Generated by Django 5.1.2 on 2024-10-16 16:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="employees",
            field=models.ManyToManyField(related_name="developers", to="app.employee"),
        ),
        migrations.CreateModel(
            name="EmployeeProxy",
            fields=[],
        ...
        migrations.AddField(
            model_name="housingcompany",
            name="shareholders",
            field=models.ManyToManyField(related_name="housing_companies", to="app.shareholder"),
        ),
        migrations.CreateModel(
            name="ShareholderProxy",
            fields=[],
            options={
                "proxy": True,
                "indexes": [],
